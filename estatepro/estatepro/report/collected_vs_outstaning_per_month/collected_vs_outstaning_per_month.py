...
def get_columns(filters):
    return [
        "Month:Data:150",
        "Collected:Currency:150",
        "Outstanding:Currency:150"
    ]
...
def get_data(filters):
    ...
    query = """
        SELECT
            ...
            SUM(ps.total_paid) as collected,
            SUM(ps.balance) as outstanding
    ...
    return {
        "data": {
            ...
            "datasets": [
                {
                    "name": "Collected",
                    "values": [row.collected for row in data],
                    "chartType": "bar"
                },
                {
                    "name": "Outstanding",
                    "values": [row.outstanding for row in data],
                    "chartType": "bar"
                }
            ]
        },
        "type": "bar",
        "colors": ["#39E4A5", "#CB2929"]
    }
